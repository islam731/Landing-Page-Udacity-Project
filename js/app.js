...
function createSection(){
    ...
    //creating a section element , creating and setting id and data-nav
     const section= document.createElement('section');
     section.setAttribute('id','section'+number);
     section.setAttribute('data-nav','Section '+number);
    ...
    //selecting <main> and storing it in variable main and appending the section into it
     ...
     headingTwo.textContent="Section "+number;
...
function scroll(){
    //Selecting <a> Elements in NavBar
...
function createNav(number,idName){
    //checking wehether its for mobile or desktop to set the id name which will be used later on
...
function activeClass(){
    ...
    function mobileMenu(){
        //creating div conatining the icon and the actual menu
        let header=document.querySelector("header");
...
//selecting all the sections and declaring here so it contains all the sections created
const sections = document.querySelectorAll('section');
mobileMenu();
//this attribute makes sure the nav always updates its contents
